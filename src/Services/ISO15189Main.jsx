...
import ISO15189 from "./ISO15189/ISO15189.jsx";
import { useNavigate } from "react-router-dom";
import { BiFirstPage } from "react-icons/bi";
import { useTheme, useMediaQuery } from "@mui/material";
import bgImage from "../assets/15189bgI.webp";

export default function ISO15189Main() {
  ...
  const headingFontSize = isMobile ? "1.6rem" : "2.7rem";
  const subHeadingFontSize = isMobile ? "0.9rem" : "1.1rem";
  const centerTopMargin = isMobile ? "100px" : "130px";
    ...
    <div>
      ...
      >
        ...
        lg: "1.5rem",  // Large Desktop
          ...
          >
            Empower your medical laboratory to deliver reliable, accurate, and trusted
            results with ISO 15189:2022 certification — ensuring quality, competence, and
            global recognition.
          </Typography>
        </div>
